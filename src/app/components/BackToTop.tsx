...
export default function BackToTop() {
  ...
  return (
    <>
      ...
      <div className={`fixed bottom-5 left-4 sm:left-6 z-[60] flex items-center transition-opacity duration-500 ${isVisible ? 'opacity-100' : 'opacity-0 pointer-events-none'}`}>
        <motion.div
